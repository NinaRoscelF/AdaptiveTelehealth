...
***Test Cases***
Financial_BillsPayment_CreateInvoice_CancelCreation_By_Supervisor
...
Financial_BillsPayment_CreateInvoice_ContinueCreation_By_Supervisor
	ath click link 	Create Invoice
	sleep 	3.0
	ath wait until loaded 	30
...
Financial_BillsPayment_CreateInvoice_InputDetailsAndSave_By_Supervisor
...
Financial_BillsPayment_CancelInvoice_CloseCancelInvoice_By_Supervisor
...
Financial_BillsPayment_CancelInvoice_ContinueWithoutReason_By_Supervisor
	ath click link 	xpath=//td[contains(normalize-space(),'${amt}')]/following::td[4]/a[text()="Cancel Invoice"]
...
Financial_BillsPayment_CancelInvoice_ContinueWithReason_By_Supervisor
