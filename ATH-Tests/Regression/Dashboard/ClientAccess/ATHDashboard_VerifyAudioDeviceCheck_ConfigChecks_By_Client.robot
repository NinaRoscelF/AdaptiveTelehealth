...
***Test Cases***
Dashboard_VerifyAudioDeviceCheck_CannotDisplayCamera_By_Client
...
Dashboard_VerifyAudioDeviceCheck_CannotHearMicrophone_By_Client
	WelcomeHeader.Click Device Check Icon
	Dashboard.DeviceCheck.Click Run Auto Device Check button
	Check Button existence 	Check my Browser
	Dashboard.DeviceCheck.Click Check My Browser button
...
Dashboard_VerifyAudioDeviceCheck_CannotHearSpeaker_By_Client
	WelcomeHeader.Click Device Check Icon
	Dashboard.DeviceCheck.Click Run Auto Device Check button
	Check Button existence 	Check my Browser
	Dashboard.DeviceCheck.Click Check My Browser button
