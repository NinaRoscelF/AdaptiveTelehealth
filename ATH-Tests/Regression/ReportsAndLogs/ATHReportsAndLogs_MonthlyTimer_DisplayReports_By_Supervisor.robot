...
***Test Cases***
ATHReportsAndLogs_MonthlyTimer_ReportDisplay_By Supervisor
...
ATHReportsAndLogs_MonthlyTimer_SelectRecordsPerPageDisplay_By_Supervisor
...
ATHReportsAndLogs_MonthlyTimer_MoveToNextPage_By Supervisor
	Move to Next Page

ATHReportsAndLogs_MonthlyTimer_MoveToPreviousPage_By Supervisor
#move to previous page
	Move to Previous Page

ATHReportsAndLogs_MonthlyTimer_SelectPageNumber_By Supervisor
#move to selected page
	Select Page Number	2

ATHReportsAndLogs_MonthlyTimer_InputSearchCriteria_By_Supervisor
...
ATHReportsAndLogs_MonthlyTimer_SaveReport_By Supervisor
