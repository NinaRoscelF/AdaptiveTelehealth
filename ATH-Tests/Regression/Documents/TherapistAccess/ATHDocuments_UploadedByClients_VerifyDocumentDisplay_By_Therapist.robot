...
***Test Cases***
ATHDocuments_UploadedByClients_VerifyDocumentDisplay_By_Therapist
...
ATHDocuments_UploadedByClients_SortDocumentColumn_By_Therapist
	Documents.SharedWithMe.Sort Document Column
	Capture Page Screenshot

ATHDocuments_UploadedByClients_SortSizeColumn_By_Therapist
	Documents.SharedWithMe.Sort Size Column
	Capture Page Screenshot

ATHDocuments_UploadedByClients_SortDateUploadedColumn_By_Therapist
	Documents.MyDocuments.Sort Date Uploaded Column
	Capture Page Screenshot

ATHDocuments_UploadedByClients_InputDocumentName_SearchCriteria_By_Therapist
...
ATHDocuments_UploadedByClients_InputSharedByName_SearchCriteria_By_Therapist
	Documents.MyDocuments.Input Search Criteria 	${ClientName}
	${status}	Run Keyword and Return Status	Document.MyDocuments.Verify No Results found
	Should Not Be True	${status}

ATHDocuments_UploadedByClients_VerifyPreviousNextPageExists_By_Therapist
