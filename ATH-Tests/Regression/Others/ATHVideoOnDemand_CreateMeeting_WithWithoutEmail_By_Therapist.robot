...
***Test Cases***
VideoOnDemand_CreateMeetingWithClient_WithEmail_By_Therapist
...
VideoOnDemand_CreateMeetingWithClient_WithoutEmail_By_Therapist
	Select Video on Demand Menu
	VideoOnDemand.Input Optional Topic	Automation Topic
...
VideoOnDemand_CreateMeetingWithClient_WithoutAttendee_By_Therapist
	Select Video on Demand Menu
	VideoOnDemand.Click Create Meeting Button
